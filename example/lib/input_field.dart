...
class InputField extends StatefulWidget {
  const InputField({
    ...
    this.controller,
    this.focusNode,
    this.decoration = const InputFieldDecoration(),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<InputFieldDecoration>('decoration', decoration, defaultValue: const InputDecoration()));
...
class _InputFieldState extends State<InputField> with RestorationMixin implements TextSelectionGestureDetectorBuilderDelegate, AutofillClient {
  ...
  InputFieldDecoration _getEffectiveDecoration() {
    final MaterialLocalizations localizations = MaterialLocalizations.of(context);
    final ThemeData themeData = Theme.of(context);
    final InputFieldDecoration effectiveDecoration = (widget.decoration ?? const InputFieldDecoration()).copyWith(
      enabled: _isEnabled,
  ...
  TextInputConfiguration get textInputConfiguration {
    ...
    final AutofillConfiguration autofillConfiguration = autofillHints != null
        ? AutofillConfiguration(
            ...
            hintText: (widget.decoration ?? const InputFieldDecoration()).hintText,
          )
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle style = (theme.useMaterial3 ? Theme.of(context).textTheme.bodyLarge! : theme.textTheme.titleMedium!).merge(widget.style);
    ...
    final SpellCheckConfiguration spellCheckConfiguration = widget.spellCheckConfiguration != null && widget.spellCheckConfiguration != const SpellCheckConfiguration.disabled()
        ? widget.spellCheckConfiguration!.copyWith(misspelledTextStyle: widget.spellCheckConfiguration!.misspelledTextStyle ?? TextField.materialMisspelledTextStyle)
